package com.tims.bootframe.common.utils.idGenerator;
...
public class IdWorker {
    ...
    private static InetAddress getPrivateIp() throws SocketException {
        ...
        if (1 != localAddresses.size()) {
            ...
            log.warn("内网IP个数不等于1,size:{},ip:{}", localAddresses.size(), ips);
        }
    ...
    private static int getPid() {
        ...
        if (index == -1) {
            throw new IllegalArgumentException("获取PID错误, name=" + name);
        }
        ...
        try {
            ...
            throw new IllegalArgumentException("获取PID错误, name=" + name, e);
        }
    }
}
